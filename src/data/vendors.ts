...
export const vendors: Vendor[] = [
  ...
  { name: 'Easy Peasy Lemon Squeezy', booth: '44', items: 'Fresh squeezed lemonade, more than 8 flavor options with added boba' },
  { name: 'Enchanted Crafts', booth: '47', items: 'Jewelry, sublimation fabric items, crochet, crystals' },
  { name: 'ERG Elite Remodeling', booth: '46', items: 'Home improvement' },
  ...
  { name: 'Nutrilite, XS & Artistry', booth: '31', items: 'Organic vitamin drinks, vitamin B12 based energy drinks, premium skincare' },
  ...
  { name: 'RP Fab LLC & Iridescent Essence', booth: '5', items: 'Soaps, bath bombs, body butter, facial serum, laser cut items, wood turned items, fabrication services' },
  ...
  { name: "Séance at Tiffany's", booth: '29', items: 'Tarot readings, candles, art, kits, bells' },
  ...
  { name: 'Soda Squeezed', booth: 'FT2', items: 'Dirty soda, lemonade', menu: '/menus/soda-squeezed-menu.png' },
